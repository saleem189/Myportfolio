...
<script setup>
import Carousel from "@/components/helpers/Carousel.vue";
import Gallery from "@/components/helpers/Gallery.vue";
import { defineProps } from 'vue';


let { showModal, portfolio, nightMode } = defineProps({
  showModal: Boolean,
  portfolio: Object,
  nightMode: Boolean
});

let open = (url) => window.open(url, "_blank");
