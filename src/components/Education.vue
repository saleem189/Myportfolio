  ...
  <Section id="education" title="Education">
    <div class="grid md:grid-cols-2 gap-8">
      ...
      >
        ...
        <h3 :class="['text-2xl font-bold mb-2 transition-colors', themeClasses.themeClass('text-blue-800', 'text-blue-300')]">{{ edu.degree }}</h3>
        <h4 :class="['text-xl font-semibold mb-2 transition-colors', themeClasses.classes.textSecondary()]">{{ edu.name || edu.school }}</h4>
        ...
        <div v-if="edu.skills && edu.skills.length > 0">
          <h5 :class="['font-bold text-sm mb-2 transition-colors', themeClasses.classes.textMuted()]">Key Focus Areas:</h5>
          <div class="flex flex-wrap gap-2">
            <span 
              ...
              :class="[
                ...
                themeClasses.themeClass('bg-blue-100 border-blue-300 text-blue-700', 'bg-slate-700 border-slate-600 text-gray-300')
              ]"
            >
              {{ skill }}
            </span>
